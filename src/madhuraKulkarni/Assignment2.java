...
public class Assignment2 {
	...
	void verifyCreateNewAccount() throws InterruptedException {
		System.out.println("Step 3 : Enter appropriate value in all textbox.");
	...
	void verifyDayIsSelectedFromDropdown() {
		...
		if (daySelected.equals("5")) {
			System.out.println("Verified the selected day from dropdown...");
	...
	void verifyMonthSeectedFromDropdown() {
		...
		if (monthSelected.equals("Aug")) {
			System.out.println("Verified the selected month from dropdown...");
			System.out.println("Test passed...");
		} else {
			System.out.println("Test failed...");
		}
	...
	void verifyIsYearSelectedFromDropdown() {
		System.out.println("Step 8 : Select Month from year dropdown");
		...
		if (yearSelected.equals("1990")) {
			System.out.println("Verified the selected year from dropdown...");
			System.out.println("Test passed...");
		} else {
			System.out.println("Test failed...");
		}
	...
	void displayData() throws InterruptedException {
		launchBrowser();
		verifyCreateNewAccount();
		verifyDayIsSelectedFromDropdown();
		verifyMonthSeectedFromDropdown();
		verifyIsYearSelectedFromDropdown();
		driver.quit();
	}

	public static void main(String[] args) throws InterruptedException {
		new Assignment2().displayData();
	}
}
