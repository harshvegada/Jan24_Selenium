...
public class Assignment4 {
	...
	void setup() {
		...
		userName1 = driver.findElement(By.xpath("//input[@id='fullName']"));
		...
		userName2 = driver.findElement(By.xpath("//input[@id='usernameReg']"));
	...
	void testcase1() {
		setup();
		System.out.println("STEP1 - Enter the Name");
		userName1.sendKeys("shramika");
		System.out.println("STEP2 - Enter the Address");
		address.sendKeys("Pune");
		System.out.println("STEP3 - Enter the Email Id");
		emailId.sendKeys("savi.vaidya17@gmail.com");
		System.out.println("STEP4 - Enter the City");
		city.sendKeys("Nagpur");
		System.out.println("STEP5 - Enter the Company Name");
		scrollElement(companyName);
		companyName.sendKeys("Systema bio");
		System.out.println("STEP6 - Enter the userName");
		scrollElement(userName2);
		userName2.sendKeys("shramika.17");
		System.out.println("STEP7 - Enter the Password");
		scrollElement(password);
		password.sendKeys("1233465");
		System.out.println("STEP8 - Re-Enter the Password");
		scrollElement(reEnterPwd);
		reEnterPwd.sendKeys("1233465");
		System.out.println("STEP9 - Click on agree Terms and Conditions Checkbox");
		scrollElement(regButton);
		agreeTerms.click();
		System.out.println("STEP10 - Click on Registration Button");
		regButton.click();
	...
	void testcase2() {
		...
		String originalName = userName1.getAttribute("value");
		userName1.clear();
		scrollElement(regButton);
		regButton.click();
		verifyAlertText("Full name can't be blank", "TC2");
		userName1.sendKeys(originalName);
	}
	...
	void testcase8() {
		...
		String originalName = userName2.getAttribute("value");
		userName2.clear();
		scrollElement(regButton);
		regButton.click();
		verifyAlertText("Username is mandatory field.", "TC8");
		userName2.sendKeys(originalName);
	}
	...
	public static void main(String[] args) {
		Assignment4 assignment_4 = new Assignment4();
