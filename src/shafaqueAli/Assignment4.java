...
public class Assignment4 {
	...
	void testcase13() {
		System.out.println(
				"Testcase13-Verify alert message for re-password when password and re-password are not matching");
		String RetypePassword1 = RetypePassword.getAttribute("value");
		JavascriptExecutor je = (JavascriptExecutor) driver;
		je.executeScript("arguments[0].scrollIntoView(true)", RetypePassword);
		RetypePassword.clear();
	...
	void testcase14() {
		System.out.println(
				"Testcase14-Verify alert message for Team and condition when Team and condition checkbox is not selected");
		JavascriptExecutor je = (JavascriptExecutor) driver;
