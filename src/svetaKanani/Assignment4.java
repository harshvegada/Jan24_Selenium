...
public class Assignment4 {
	...
	public void testcase1() {
		...
		driver.findElement(By.xpath("//input[@placeholder='Full Name']")).sendKeys("sveta kanani");
		
		System.out.println("Enter Address...");
		driver.findElement(By.xpath("//input[@placeholder='Address']")).sendKeys("Jamnagar");
		
		System.out.println("Enter Email id...");
		driver.findElement(By.xpath("//input[@placeholder='Other Email ID']")).sendKeys("sveta@gmail.com");
		
		System.out.println("Enter City/Town name..");
		driver.findElement(By.xpath("//input[@placeholder='City/Town']")).sendKeys("Jamnagar");
		
		System.out.println("Enter Company Name..");
		driver.findElement(By.xpath("//input[@placeholder='Company Name/Student']")).sendKeys("JVIMS");
		
		System.out.println("Select radio button");
		driver.findElement(By.xpath("//label/input[@id='radio-02']")).click();
		
		System.out.println("Enter Username..");
		driver.findElement(By.xpath("//input[@id='usernameReg']")).sendKeys("svetakanani");
		
		System.out.println("Enter password..");
		driver.findElement(By.xpath("//input[@id='passwordReg']")).sendKeys("sveta123");
		
		System.out.println("Enter Repassword..");
		driver.findElement(By.xpath("//input[@id='repasswordReg']")).sendKeys("sveta123");
	...
	public void testCase5() {
		...
		System.out.println("Enter Email id...");
		driver.findElement(By.xpath("//input[@placeholder='Other Email ID']")).sendKeys("sveta@gmail");
	...
	public void testCase9() {
		...
		System.out.println("Enter Username..");
		driver.findElement(By.xpath("//input[@id='usernameReg']")).sendKeys("sveta");
...
public void testcase11() {
		...
		System.out.println("Enter password..");
		driver.findElement(By.xpath("//input[@id='passwordReg']")).sendKeys("sveta");
	...
	public void testCase13() {
		...
		System.out.println("Enter Repassword..");
		driver.findElement(By.xpath("//input[@id='repasswordReg']")).sendKeys("sveta");
